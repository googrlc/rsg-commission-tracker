...
def as_iso_date(value: Any) -> str | None:
    ...
    """
    from hermes_finance.statements import as_date
...
def _progressive_stated(summary: Sheet | None) -> tuple[Decimal | None, Decimal | None]:
    ...
    nobody can falsify.
    """
    from hermes_finance.statements import as_money
...
def parse_progressive(book: Workbook) -> CarrierParse:
    from hermes_finance.statements import as_money, as_rate, normalize_transaction_type
